...
// import frc.robot.Commands.IntakeCommands.IntakeSetPrecent;
...
//   public FloorToElevatorIntake(GripperSubsystem coralIntakeSubsystem , IntakeSubsystem algaeIntakeSubsystem , double CoralPrecent) {
...
//     addCommands(new SmartGripperControl(coralIntakeSubsystem, CoralPrecent) , new IntakeSetPrecent(algaeIntakeSubsystem));
//   }
// }
