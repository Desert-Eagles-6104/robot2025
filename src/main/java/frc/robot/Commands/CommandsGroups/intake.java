...
//   public intake(ElevatorSubsystem elevator , GripperArmSubsystem coralArm, IntakeArmSubsystem algaeArm , double ElevatorPosition , double AlgaeArmAngle , double CoralArmAngle, GripperSubsystem coralIntakeSubsystem , IntakeSubsystem algaeIntakeSubsystem , double CoralPrecent) {
//     m_elevator = elevator;
//     m_coralArm = coralArm;
//     m_AlgaeArm = algaeArm;
...
//     addCommands(new SmartPreset(elevator, coralArm, algaeArm ,ElevatorPosition , AlgaeArmAngle , CoralArmAngle) , new FloorToElevatorIntake(coralIntakeSubsystem, algaeIntakeSubsystem, CoralPrecent) ,  new SmartPreset( elevator, coralArm, algaeArm ,ElevatorPosition , AlgaeArmAngle , CoralArmAngle));
//   }
// }