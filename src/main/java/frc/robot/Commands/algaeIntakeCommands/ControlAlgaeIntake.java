...
public class ControlAlgaeIntake extends Command {
  private AlgaeIntakeSubsystem m_AlgaeIntake;
  private double m_output = 0;
  /** Creates a new ControlAlgaeIntake. */
  public ControlAlgaeIntake(AlgaeIntakeSubsystem algaeIntake , double output) {
  ...
  public void initialize() {
    m_AlgaeIntake.setMotorPrecent(m_output);
  }
