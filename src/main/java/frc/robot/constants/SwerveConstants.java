...
/**
 * Holds all the constants for the robot swerve drivetrain and modules. The
 * drivetrain also includes the pigeon and gyro configurations.
 */
public final class SwerveConstants {
    ...
    // Swerve Modules
    private static final int FRONT_LEFT_DRIVE_MOTOR_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                     // tune
    private static final int FRONT_LEFT_STEER_MOTOR_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                     // tune
    private static final int FRONT_LEFT_STEER_ENCODER_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                       // tune

    private static final int FRONT_RIGHT_DRIVE_MOTOR_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                      // tune
    private static final int FRONT_RIGHT_STEER_MOTOR_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                      // tune
    private static final int FRONT_RIGHT_STEER_ENCODER_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                        // tune

    private static final int BACK_LEFT_DRIVE_MOTOR_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                    // tune
    private static final int BACK_LEFT_STEER_MOTOR_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                    // tune
    private static final int BACK_LEFT_STEER_ENCODER_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                      // tune

    private static final int BACK_RIGHT_DRIVE_MOTOR_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                     // tune
    private static final int BACK_RIGHT_STEER_MOTOR_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                     // tune
    private static final int BACK_RIGHT_STEER_ENCODER_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                       // tune

    // Switch
    public static final int NEUTRAL_MODE_SWITCH_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                                 // tune
    public static final int HOME_BUTTON_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                         // tune

    // Color sensor
    public static final int CANANDCOLOR_ID = ProjectConstants.ERROR_CODE;// TODO:
                                                                         // tune

    /**
     * Wheel radius in meters. Accuracy in these measurements affects wheel
     * odometry which measures distance as a function of the number of rotations
     * * wheel circumference.
     */
    private static final double WHEEL_RADIUS_METERS = CHOSEN_MODULE_CONSTANTS.wheelDiameter / 2.0;

    private static final double DRIVE_MOTOR_PINION_TEETH_COUNT = ProjectConstants.ERROR_CODE;// TODO:
                                                                                             // tune
    /**
     * Ratio between the drive motor shaft and the output shaft the wheel is
     * mounted on.
     */
    private static final double DRIVE_GEAR_RATIO = ProjectConstants.ERROR_CODE;// TODO:
                                                                               // tune

    /**
     * Ratio between the steer motor shaft and the steer output shaft.
     */
    private static final double STEER_GEAR_RATIO = ProjectConstants.ERROR_CODE;// TODO:
                                                                               // tune

    /**
     * The coupled gear ratio between the CanCoder and the drive motor. Every 1
     * rotation of the steer motor results in coupled ratio of drive turns.
     */
    private static final double COUPLING_GEAR_RATIO = ProjectConstants.ERROR_CODE / DRIVE_MOTOR_PINION_TEETH_COUNT;// TODO:
                                                                                                                   // tune
     ...
     */
    private static final double WHEELBASE_LENGTH_METERS = ProjectConstants.ERROR_CODE;// TODO:
                                                                                      // tune
     ...
     */
    private static final double WHEEL_TRACK_WIDTH_METERS = ProjectConstants.ERROR_CODE;// TODO:
                                                                                       // tune

    /**
     * The maximum speed of the robot in meters per second.
     */
    private static final double MAX_SPEED_METERS_PER_SECOND = ProjectConstants.ERROR_CODE;// TODO:
                                                                                          // tune

    /**
     * The maximum angular speed of the robot in radians per second. If set to
     * 0, the value is calculated using the max speed in meters per second and
     * the wheelbase radius.
     */

    // CANcoder offsets of the swerve modules - bevel gears pointing left of the
    // robot
    private static final double FRONT_LEFT_STEER_OFFSET_ROTATIONS = ProjectConstants.ERROR_CODE;// TODO:
                                                                                                // tune

    private static final double FRONT_RIGHT_STEER_OFFSET_ROTATIONS = ProjectConstants.ERROR_CODE;// TODO:
                                                                                                 // tune
    private static final double BACK_LEFT_STEER_OFFSET_ROTATIONS = ProjectConstants.ERROR_CODE;// TODO:
                                                                                               // tune
    private static final double BACK_RIGHT_STEER_OFFSET_ROTATIONS = ProjectConstants.ERROR_CODE;// TODO:
                                                                                                // tune

    private static final int GYRO_MOUNTING_ANGLE = ProjectConstants.ERROR_CODE;// TODO:
                                                                               // tune
    ...
    private static SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> getDefaultSwerveModuleConstants() {
        return new SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>()
                ...
                .withDriveMotorType(SwerveModuleConstants.DriveMotorArrangement.TalonFX_Integrated)// TODO:
                                                                                                   // tune
                .withSteerMotorType(SwerveModuleConstants.SteerMotorArrangement.TalonFX_Integrated)// TODO:
                                                                                                   // tune
                .withDriveMotorClosedLoopOutput(SwerveModuleConstants.ClosedLoopOutputType.Voltage)// TODO:
                                                                                                   // tune
                .withSteerMotorClosedLoopOutput(SwerveModuleConstants.ClosedLoopOutputType.Voltage)// TODO:
                                                                                                   // tune
                ...
                .withSteerMotorGains(new Slot0Configs()
                        ...
                        .withKD(CHOSEN_MODULE_CONSTANTS.steerKD))// TODO: tune
