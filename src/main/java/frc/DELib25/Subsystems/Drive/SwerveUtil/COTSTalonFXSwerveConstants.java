...
public class COTSTalonFXSwerveConstants {
    ...
    public COTSTalonFXSwerveConstants(double wheelDiameter, double steerGearRatio, double driveGearRatio, double steerKP, double steerKI, double steerKD, InvertedValue driveMotorInvert, InvertedValue steerMotorInvert, SensorDirectionValue cancoderInvert) {
    ...
    public static final class WCP {
        ...
        public static final class SwerveXStandard {
            ...
            public static final COTSTalonFXSwerveConstants Falcon500(double driveGearRatio) {
                ...
                /** (396 / 35) : 1 */
                double steerGearRatio = ((396.0 / 35.0) / 1.0);
                ...
                return new COTSTalonFXSwerveConstants(wheelDiameter, steerGearRatio, driveGearRatio, steerKP, steerKI, steerKD, driveMotorInvert, steerMotorInvert, cancoderInvert);
            }
        ...
        public static final class SwerveXFlipped {
            ...
            public static final COTSTalonFXSwerveConstants Falcon500(double driveGearRatio) {
                ...
                /** (468 / 35) : 1 */
                double steerGearRatio = ((468.0 / 35.0) / 1.0);
